...
@;		16+:	gelatina doble (a sumarle código de elemento)
	...
	@; mapa 6: combinaciones en vertical de 3, 4 y 5 elementos
		.byte 1 ,3 ,4 ,1 ,5 ,6 ,2 ,15,0
		.byte 1 ,3 ,1 ,4 ,2 ,5 ,7 ,15,0
		.byte 1 ,3 ,4 ,4 ,2 ,5 ,15, 7,0
		.byte 2 ,7 ,4 ,2 ,6 ,15, 2, 7,15
		.byte 2 ,0 ,4 ,15,6 ,6 ,5 ,7 ,15
		.byte 2 ,7 ,4 ,5 ,5 ,15,6 ,7 ,15
		.byte 2 ,7 ,15,17,6 ,5 ,6 ,7 ,0
		.byte 7 ,15,15,0 ,0 ,5 ,6 ,7 ,15
	...
	@; mapa 8: no hay combinaciones ni secuencias
		.byte 15,15,15,15,15,4,15,15,15
		.byte 15,15,4,4,4,4,4,4,15
		.byte 1,2,3,3,7,3,15,4,15
		.byte 1,2,7,5,3,7,15,3,15
		.byte 7,1,1,2,3,9,5,1,15
		.byte 1,4,20,10,9,6,15,8,3
		.byte 6,18,22,5,6,2,15,7,4
		.byte 12,5,4,3,11,5,15,15,15
		.byte 7,7,17,19,4,6,15,15,1
