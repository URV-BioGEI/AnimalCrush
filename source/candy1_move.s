...
baja_verticales:
		...
		@;fase 2IC
		push {r0-r12, lr}				@;Alb:com ens trobem a la primera fila i creem un element nou per baixar-lo creem el corresponent sprite per aquell tipus de gelatina
		mov r0, r8						@;r8=tipus de gelatina 
		bl crea_elemento				@;genereacio del sprite (es passa per r0=tipus de gelatina, r1=fila, r2=columna)		
		pop {r0-r12, pc}
		...
		@;fase 2IC
		push {}
		mov r2, 						@;nose on ficar el activar elementos (necesito fila i columna inicials, fila i columna desti...) 
